      ...
      return Scaffold(
        appBar: AppBar(
            title: Text("Edit Profile",
                style: TextStyle(fontFamily: "IBMPlexSans", fontSize: 25.0)),
            titleSpacing: 20.0,
                  ...
                  child: TextFormField(
                    decoration: InputDecoration(
                        border: OutlineInputBorder(
                          borderSide:
                              BorderSide(color: Color(0xff000070), width: 1.5),
                        ),
              ...
              Container(
                  child: TextFormField(
                    decoration: InputDecoration(
                        border: OutlineInputBorder(
                          borderSide:
                              BorderSide(width: 1.5, color: Color(0xff000070)),
                        ),
                        enabledBorder: OutlineInputBorder(
                            borderSide: BorderSide(
                                width: 1.5, color: Color(0xff000070))),
                        focusedBorder: OutlineInputBorder(
                            borderSide: BorderSide(
                                width: 1.5, color: Color(0xff000070))),
                ...
                OutlineButton(
                    child: Text("Cancel",
                        style: TextStyle(
                            ...
                            color: Color(0xff000070),
                            fontSize: 22.0)),
                    borderSide: BorderSide(color: Color(0xff000070)),
                    onPressed: () {
                      _clearInputs();
                ...
                RaisedButton(
                    ...
                    onPressed: () async {
                      ...
                      await _userCollection
                          .document(loginInfo.userData["unique_id"])
                          .updateData({
                        "display_name": usernameController.text != ""
                            ? usernameController.text
                            : loginInfo.userData["display_name"],
                        "status": statusController.text != ""
                            ? statusController.text
                            : loginInfo.userData["status"],
                        "info": infoController.text != ""
                            ? infoController.text
                            : loginInfo.userData["info"]
                      });
